...
export const spec = {
  ...
  paths: {
    ...
    '/entities/by-name/{kind}/{namespace}/{name}/status': {
      get: {
        operationId: 'GetEntityStatusSourcesByName',
        tags: ['Entity'],
        description: 'List the status sources for an entity.',
        responses: {
          '200': {
            description: 'List of status sources.',
            content: {
              'application/json': {
                schema: {
                  type: 'object',
      ...
      post: {
        operationId: 'UpdateEntityStatusByName',
        tags: ['Entity'],
        description: 'Update the status of an entity from an external source.',
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  source: {
                    type: 'string',
                    description: 'The source of the status update.',
                  },
                  status: {
                    type: 'object',
                    description: 'The status data to merge into the entity.',
                  },
                },
              },
            },
        ...
        responses: {
          '204': {
            description:
              'Status updated successfully. A stitch is triggered by default. Pass `?stitch=skip` to write status without triggering a stitch.\n',
          },
          '400': {
            $ref: '#/components/responses/ErrorResponse',
          },
        ...
        parameters: [
          ...
          },
          {
            ...
            description:
              'When set to `skip`, the status is written but no stitch is triggered. The caller is responsible for triggering a stitch separately.\n',
          },
        ],
      },
      delete: {
        operationId: 'DeleteEntityStatusByName',
        tags: ['Entity'],
        description:
        ...
        parameters: [
          ...
          },
          {
            ...
            description: 'The source of the status to delete.',
          },
          {
            name: 'stitch',
            in: 'query',
            ...
            description:
              'When set to `skip`, the status is deleted but no stitch is triggered.\n',
          },
        ],
        responses: {
          '204': {
    ...
    '/entities/status-batch': {
      post: {
          ...
          content: {
            'application/json': {
              schema: {
                ...
                items: {
                  type: 'object',
                  required: ['entityRef', 'source', 'status'],
                  properties: {
                    entityRef: {
                      type: 'string',
                      description:
                        'Entity reference, e.g. `component:default/my-api`.\n',
                    },
                    source: {
                      type: 'string',
                      description: 'The source of the status update.',
        ...
        responses: {
          '204': {
            description: 'All status updates applied successfully.',
          },
          '207': {
            description:
              'Multi-status response. Some entries succeeded and some failed. The `results` array contains per-entry outcomes.\n',
            content: {
              'application/json': {
                schema: {
                  type: 'object',
        ...
        parameters: [
          {
            ...
            description:
              'When set to `skip`, statuses are written but no stitch is triggered.\n',
          },
        ],
      },
    },
