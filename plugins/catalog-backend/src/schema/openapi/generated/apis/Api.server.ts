...
export type BatchUpdateEntityStatus = {
  ...
  response: void | BatchUpdateEntityStatus207Response | Error | Error;
};
/**
 * @public
 */
...
export type GetEntityStatusSourcesByName = {
  ...
  response: GetEntityStatusSourcesByName200Response | Error | Error;
};
/**
 * @public
 */
...
export type EndpointMap = {
  '#post|/entities/status-batch': BatchUpdateEntityStatus;

  '#_delete|/entities/by-uid/{uid}': DeleteEntityByUid;

  '#_delete|/entities/by-name/{kind}/{namespace}/{name}/status': DeleteEntityStatusByName;
  ...
  '#get|/entities/by-name/{kind}/{namespace}/{name}/status': GetEntityStatusSourcesByName;
  ...
  '#post|/entities/by-name/{kind}/{namespace}/{name}/status': UpdateEntityStatusByName;
